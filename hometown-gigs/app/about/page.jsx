    ...
    <div className="w-full md:w-3/4 m-auto p-11">
      <section>
        ...
        <p className="text-md text-white mt-8 md:text-xl font-thin">
          ...
          together venues, bands, solo artists, photographers, recording
          engineers, producers, and music enthusiasts, creating a harmonious
      ...
      <section className="mt-8">
        ...
        <p className="text-md text-white mt-2 md:text-xl font-thin">
          ...
          performances, where local artists flourish, and where music lovers
          easily connect with the best shows in their area.
        </p>
      </section>
      <section className="mt-8">
        ...
        <p className="text-md text-white mt-2 md:text-xl font-thin">
          ...
          creating unforgettable live experiences. Hometown Gigs is here to
          facilitate those connections and make it easier for everyone to come
          together.
        </p>
      </section>
      <section className="mt-8">
